...
public class Santa extends Npc {
    ...
    public void openBaseMenu(Player player) {
        if (canOpenNpc(player)) {
            ...
            // Tên các mục ở đây là MẶC ĐỊNH. Muốn đổi thì sửa trên panel —
            // Npc.createOtherMenu() thay tên theo bảng npc_menu trước khi gửi
            // cho client, áp cho mọi NPC chứ không riêng NPC này.
            ...
            if (!player.inventory.itemsDaBan.isEmpty()) {
                menu.add(3, "Mua lại\nvật phẩm\nđã bán\n["
                        + player.inventory.itemsDaBan.size() + "/"
                        + BuyBack.MAX_COUNT_IN_BOX + "]");
            }
