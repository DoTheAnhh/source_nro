...
public class ItemTime {
    ...
    /**
     * Dòng hiện <b>id + tên bản đồ + khu</b> đang đứng.
     *
     * <p>Ô chữ mà client vẽ sẵn ở góc màn hình chỉ in id và khu, không in tên —
     * máy chủ có gửi {@code mapName} trong gói {@code -24} nhưng client không
     * dùng, mà client là bản dựng IL2CPP không sửa được. Dòng này là đường máy
     * chủ tự bày ra được.</p>
     */
    public static final byte TEXT_MAP_HIEN_TAI = 8;
