...
public class NewSkill {
    ...
    private void update() {
        // Ban cu viet "= true" — GAN chu khong so sanh. Cu moi nhip 250ms no
        // bat lai co, nen co khong bao gio tat duoc: Boss.update() thay co bat
        // la thoat som, con boss dung hinh vinh vien sau lan dung chieu dau.
