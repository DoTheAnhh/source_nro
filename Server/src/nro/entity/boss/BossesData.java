...
public class BossesData {
    ...
    public static BossData CUMBER = new BossData(
            "Cumber", //name
    ...
    //**************************************************************************
    //?
    public static BossData TestBoss = new BossData(
            "TestBosss", //name
    ...
    public static BossData  Darbula2 = new BossData(
    ...
    public static BossData  Darbula3 = new BossData(
            "Pikachu", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    //**************************************************************************
    public static BossData NguoiXayda = new BossData(
            "Người Xayda",
            ConstPlayer.XAYDA,
    ...
    //**************************************************************************
    public static BossData KhiCon = new BossData(
            "Khỉ Con",
    ...
    public static BossData KhiCon2 = new BossData(
            "Khỉ Con",
            ConstPlayer.TRAI_DAT,
            new short[]{462, 463, 464, -1, -1, -1},
            50000,
    ...
    public static BossData KhiCon3 = new BossData(
            "Khỉ Con",
            ConstPlayer.TRAI_DAT,
            new short[]{462, 463, 464, -1, -1, -1},
            50000,
    ...
    public static BossData KhiCon4 = new BossData(
            "Khỉ Con",
            ConstPlayer.TRAI_DAT,
            new short[]{462, 463, 464, -1, -1, -1},
            50000,
    ...
    public static BossData KhiCon5 = new BossData(
            "Khỉ Con",
            ConstPlayer.TRAI_DAT,
            new short[]{462, 463, 464, -1, -1, -1},
            50000,
    ...
    public static BossData GranolaManager = new BossData(
            "Phân Thân Granola",
            ConstPlayer.NAMEC,
    ...
    //**************************************************************************
    public static BossData DrLyche = new BossData(
            "Dr Lyche", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData HaChiJack = new BossData(
            "HaChiJack", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    //*************************************************************************
    public static BossData NguuMaVuong = new BossData(
            "Ngưu Ma Vương", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData NgoKhong = new BossData(
            "Tôn Ngộ Không", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    //***************************************************************************
    public static BossData GiaiPhongAnNgoKhong = new BossData(
    ...
    //****************************************************************************
    public static BossData HoTongDuongTang = new BossData(
            "Đường Tăng",
            (byte) 0,
    ...
    //**************************************************************************
    public static BossData oren = new BossData(
            "Oren", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData kami = new BossData(
            "Kami", //name
            ConstPlayer.XAYDA, //gender
    ...
    //**************************************************************************
    public static BossData BLACKGOKU = new BossData(
            "Black Goku", //name
            ConstPlayer.TRAI_DAT, //gender
        ...
        public static BossData ZAMAS = new BossData(
            "Kaioshin Zamas", //name
            ConstPlayer.TRAI_DAT, //gender
        ...
        public static BossData THANZM2 = new BossData(
    ...
    //************************************************************************** Boss hủy diệt
            public static BossData WHIS_TWO = new BossData(
            "Thiên sứ Whis", //name
            ConstPlayer.TRAI_DAT, //gender
            ...
            REST_30_M
                ...
                public static BossData BERUS = new BossData(
    ...
    //*****************************************************************************
        public static BossData VADOS = new BossData(
            "Thiên sứ Vados", //name
        ...
        public static BossData CHAMPA = new BossData(
...
//===============================================================================
//---------------------BOSS MAI SU  PILAF -------------------------------    
    public static BossData KAMIRIN = new BossData(
            "Thần Tài 1", //name
            ConstPlayer.TRAI_DAT, //gender
...
//-------------------------------BOSS DATA--------------------------------------
    public static BossData POLICE = new BossData(
            "Police",
            ConstPlayer.NAMEC,
    ...
    public static BossData POLICE_2 = new BossData(
            "Police",
            ConstPlayer.NAMEC,
            new short[]{1614, 631, 632, -1, -1, -1},
            100000,
    ...
    //-------------------------------BOSS DATA--------------------------------------
    public static BossData POLICE_CHARACTERISTIC = new BossData(
            "Police",
            ConstPlayer.NAMEC,
            new short[]{1614, 631, 632, -1, -1, -1},
            2000000,
    ...
    public static BossData POLICE_CHARACTERISTIC_2 = new BossData(
            "Police",
            ConstPlayer.NAMEC,
            new short[]{1614, 631, 632, -1, -1, -1},
            20000000,
    ...
    public static BossData POLICE_CHARACTERISTIC_3 = new BossData(
            "Police",
            ConstPlayer.NAMEC,
            new short[]{1614, 631, 632, -1, -1, -1},
            20000000,
    ...
    public static BossData GOHAN_NHAT_NGUYET = new BossData(
    ...
    //////
    public static BossData BILL = new BossData(
            "Berrus", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1381, 1382, 1383, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            500, //dame
...
//--------------------------BOSS FROST------------------------------------------
    public static BossData FROST = new BossData(
            "Frost 1", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData FROST_2 = new BossData(
            "Frost 2", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData FROST_3 = new BossData(
            "Frost 3", //name
            ConstPlayer.TRAI_DAT, //gender
...
//--------------------------BOSS COOLER-----------------------------------------
    public static BossData COOLER = new BossData(
            "Cooler", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData COOLER_2 = new BossData(
            "Cooler 2", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData Chilled = new BossData(
            "Chilled", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData Chilled_2 = new BossData(
            "Chilled 2", //name
            ConstPlayer.XAYDA, //gender
...
//--------------------------BOSS TASK FUTURE------------------------------------
    public static BossData BLACK_GOKU = new BossData(
            "Black Goku", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData SUPER_BLACK_GOKU = new BossData(
    ...
    //--------------------------BOSS GOMAH -----------------------------------
    public static BossData GOMAH= new BossData(
            "Gomah Tà Ám", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData GOMAH1 = new BossData(
            "Gomah Hắc Ám", //name
            ConstPlayer.TRAI_DAT, //gender
...
//--------------------------BOSS VALENTINE EVENT--------------------------------
    public static BossData THO_BUNMA = new BossData(
            "Thỏ Bunma", //name
            ConstPlayer.TRAI_DAT, //gender
...
//--------------------------BOSS TRUNG THU EVENT--------------------------------
    public static BossData THO_DAI_KA = new BossData(
            "Thỏ Đại Ka", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData NGUYETTHAN = new BossData(
            "Nguyệt thần", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData NHATTTHAN = new BossData(
            "Nhật thần", //name
            ConstPlayer.XAYDA, //gender
    ...
    //
    public static BossData GOGETA = new BossData(
            "Gogeta", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData OMEGA = new BossData(
            "Omega", //name
            ConstPlayer.XAYDA, //gender
...
//--------------------------BOSS HALLOWEEN EVENT--------------------------------
    public static BossData MA_TROI = new BossData(
            "Ma trơi", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData DOI = new BossData(
            "Dơi", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData XUONG_KHO = new BossData(
            "Xương khô", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData BI_NGO = new BossData(
            "Vua Bí", //name
            ConstPlayer.XAYDA, //gender
...
//--------------------------BOSS VULAN EVENT------------------------------------
    public static BossData PIKKON = new BossData(
            "Pikkon", //name
            ConstPlayer.NAMEC, //gender
...
//--------------------------BOSS CHRIST MAS EVENT-------------------------------
    public static BossData TUAN_LOC = new BossData(
            "Tuần lộc", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData GOKU_GOD_NOEL = new BossData(
    ...
    public static BossData BROLY_NOEL = new BossData(
            "Broly", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData COLD_NOEL = new BossData(
            "Golden Cooler", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData GOKU_NOEL = new BossData(
            "Gôku Santa", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData CHICHI_NOEL = new BossData(
...
//--------------------------BOSS ENVENT LUNAR NEW YEAR--------------------------
    //NEW YEAR DRAGON
    public static BossData NEW_YEAR_DRAGON_1 = new BossData(
            "Gôku dragon", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData NEW_YEAR_DRAGON_2 = new BossData(
            "Pôcôlô dragon", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData NEW_YEAR_DRAGON_3 = new BossData(
            "Cađíc dragon", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    //THẦN TÀI
    public static BossData THAN_TAI_1 = new BossData(
            "Thần tài 1", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData THAN_TAI_2 = new BossData(
            "Thần tài 2", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData THAN_TAI_3 = new BossData(
            "Thần tài 3", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    //
    public static BossData LAN_CON = new BossData(
            "Lân con", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData BE_NA = new BossData(
            "", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData PI_LONG = new BossData(
            "PiLong", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData MEO_DEN = new BossData(
            "Mèo đen", //name
            ConstPlayer.XAYDA, //gender
...
//--------------------------BOSS TIỂU ĐỘI PILAP---------------------------------
    public static BossData MAI = new BossData(
            "Mai", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData SHU = new BossData(
            "Su", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData PI_LAP = new BossData(
            "PiLap", //name
            ConstPlayer.TRAI_DAT, //gender
...
//--------------------------BOSS SUPER BROLY------------------------------------
    public static BossData SUPPER_BROLY = new BossData(
            "Super Broly", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData SUPPER_BROLY_ZONE0 = new BossData(
            "Super Broly", //name
            ConstPlayer.XAYDA, //gender
            new short[]{294, 295, 296, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            100, //dame
    ...
    public static BossData SUPPER_BROLY_NEW = new BossData(
            "Super Broly", //name
            ConstPlayer.XAYDA, //gender
            new short[]{294, 295, 296, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            150000, //dame
...
//---------------------BOSS TIỂU ĐỘI SÁT THỦ NAMEK------------------------------
    public static BossData SO_4_NAMEK = new BossData(
            "Số 4 - Namek", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData SO_3_NAMEK = new BossData(
            "Số 3 - Namek", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData SO_2_NAMEK = new BossData(
            "Số 2 - Namek", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData SO_1_NAMEK = new BossData(
            "Số 1 - Namek", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData TIEU_DOI_TRUONG_NAMEK = new BossData(
...
//---------------------BOSS TASK------------------------------------------------
    //XEN BO HUNG
    public static BossData XEN_BO_HUNG_1 = new BossData(
            "Xên bọ hung",
            ConstPlayer.XAYDA,
    ...
    public static BossData XEN_BO_HUNG_2 = new BossData(
            "Xên bọ hung 2",
            ConstPlayer.XAYDA,
    ...
    public static BossData XEN_BO_HUNG_3 = new BossData(
            "Xên hoàn thiện",
            ConstPlayer.XAYDA,
    ...
    public static BossData SIEU_BO_HUNG_1 = new BossData(
            "Xên Hoàn Thiện",
            ConstPlayer.XAYDA,
            new short[]{234, 235, 236, -1, -1, -1},
            100000,
    ...
    public static BossData SIEU_BO_HUNG_2 = new BossData(
            "Siêu Bọ Hung",
            ConstPlayer.XAYDA,
            new short[]{234, 235, 236, -1, -1, -1},
            300000,
    ...
    //XEN CON
    public static BossData XEN_CON_1 = new BossData(
            "Xên con 1", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData XEN_CON_2 = new BossData(
            "Xên con 2", //name
            ConstPlayer.XAYDA, //gender
            new short[]{264, 265, 266, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            150000, //dame
    ...
    public static BossData XEN_CON_3 = new BossData(
            "Xên con 3", //name
            ConstPlayer.XAYDA, //gender
            new short[]{264, 265, 266, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            150000, //dame
    ...
    public static BossData XEN_CON_4 = new BossData(
            "Xên con 4", //name
            ConstPlayer.XAYDA, //gender
            new short[]{264, 265, 266, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            150000, //dame
    ...
    public static BossData XEN_CON_5 = new BossData(
            "Xên con 5", //name
            ConstPlayer.XAYDA, //gender
            new short[]{264, 265, 266, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            150000, //dame
    ...
    public static BossData XEN_CON_6 = new BossData(
            "Xên con 6", //name
            ConstPlayer.XAYDA, //gender
            new short[]{264, 265, 266, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            150000, //dame
    ...
    public static BossData XEN_CON_7 = new BossData(
            "Xên con 7", //name
            ConstPlayer.XAYDA, //gender
            new short[]{264, 265, 266, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            150000, //dame
    ...
    //ROBOT SAT THU
    //ANDROID 19, 20
    public static BossData DR_KORE = new BossData(
            "Dr.Kôrê", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData ANDROID_19 = new BossData(
            "Android 19", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    //ANDROID 13, 14, 15
    public static BossData ANDROID_13 = new BossData(
            "Android 13", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData ANDROID_14 = new BossData(
            "Android 14", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData ANDROID_15 = new BossData(
            "Android 15", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    //PIC, POC, KINGKONG
    public static BossData PIC = new BossData(
            "Pic", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData POC = new BossData(
            "Poc", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData KING_KONG = new BossData(
            "King Kong", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    //FIDE DAI KA
    public static BossData FIDE_DAI_CA_1 = new BossData(
            "Fide đại ca 1", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData FIDE_DAI_CA_2 = new BossData(
            "Fide đại ca 2", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData FIDE_DAI_CA_3 = new BossData(
            "Fide đại ca 3", //name
            ConstPlayer.XAYDA, //gender
    ...
    //TIEU DOI SAT THU
    public static BossData SO_4 = new BossData(
            "Số 4", //name
            ConstPlayer.XAYDA, //gender
            new short[]{168, 169, 170, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            10000, //dame
    ...
    public static BossData SO_3 = new BossData(
            "Số 3", //name
            ConstPlayer.XAYDA, //gender
            new short[]{174, 175, 176, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            11000, //dame
    ...
    public static BossData SO_2 = new BossData(
            "Số 2", //name
            ConstPlayer.XAYDA, //gender
            new short[]{171, 172, 173, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            12000, //dame
    ...
    public static BossData SO_1 = new BossData(
            "Số 1", //name
            ConstPlayer.XAYDA, //gender
            new short[]{177, 178, 179, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            12500, //dame
    ...
    public static BossData TIEU_DOI_TRUONG = new BossData(
    ...
    //NAPA
    public static BossData KUKU = new BossData(
            "Kuku", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData MAP_DAU_DINH = new BossData(
            "Mập Đầu Đinh", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData RAMBO = new BossData(
            "Rambo", //name
            ConstPlayer.XAYDA, //gender
    ...
    //TAU PAY PAY
    public static BossData TAUPAYPAY = new BossData(
            "Tàu Pảy Pảy", //name
            ConstPlayer.TRAI_DAT, //gender
...
//---------------------BOSS 21H-------------------------------------------------
    public static BossData GOLDEN_FRIEZA = new BossData(
            "Fide Vàng", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData DEATH_BEAM = new BossData(
            "$", //name
            ConstPlayer.XAYDA, //gender
...
//---------------------BOSS SƠN TINH THUỶ TINH----------------------------------
    ...
    public static BossData RONG_NHI_1S = new BossData(
            ...
            new long[]{100_000}, //hp — mỗi đòn mất đúng 1% nên vẫn là 100 đòn
    ...
    public static BossData THUY_TINH = new BossData(
            "Thủy Tinh", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData SON_TINH = new BossData(
            "Sơn Tinh", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData THUY_TINH_NEW = new BossData(
            "Thủy Tinh", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData SON_TINH_NEW = new BossData(
            "Sơn Tinh", //name
            ConstPlayer.XAYDA, //gender
...
//---------------------BOSS TIỂU ĐỘI BOJACK-------------------------------------
    public static BossData BUJIN = new BossData(
            "Bujin", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData KOGU = new BossData(
            "Kogu", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData ZANGYA = new BossData(
            "Zangya", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData BIDO = new BossData(
            "Bido", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData BOJACK = new BossData(
            "Bojack", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData SUPER_BOJACK = new BossData(
            "Siêu Bojack", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData SUPER_BOJACK_2 = new BossData(
            "Siêu Bojack", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{326, 327, 328, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            300000, //dame
...
//---------------------BOSS ÔNG GIÀ NOEL----------------------------------------
    public static BossData ONG_GIA_NOEL = new BossData(
            "Ông già Noel", //name
            ConstPlayer.XAYDA, //gender
...
//---------------------BOSS ĐÔNG NAM KARIN--------------------------------------
    public static BossData TAU_PAY_PAY_DONG_NAM_KARIN = new BossData(
            "Tàu Pảy Pảy", //name
            ConstPlayer.TRAI_DAT, //gender
...
//---------------------BOSS ĐẠI HỘI VÕ THUẬT 23---------------------------------
    public static BossData SOI_HEC_QUYN = new BossData(
            "Sói hẹc quyn", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData O_DO = new BossData(
            "Ở dơ", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData XINBATO = new BossData(
            "Xinbatô", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData CHA_PA = new BossData(
            "Cha pa", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData PON_PUT = new BossData(
            "Pon put", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData CHAN_XU = new BossData(
            "Chan xư", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData TAU_PAY_PAY = new BossData(
            "Tàu Pảy Pảy", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{92, 93, 94, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            40000, //dame
    ...
    public static BossData YAMCHA = new BossData(
            "Yamcha", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData JACKY_CHUN = new BossData(
            "Jacky Chun", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{356, 357, 358, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            60000, //dame
    ...
    public static BossData THIEN_XIN_HANG = new BossData(
            "Thiên xin hăng", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData THIEN_XIN_HANG_CLONE = new BossData(
            "Thiên xin hăng", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{368, 369, 370, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            60000, //dame
    ...
    public static BossData LIU_LIU = new BossData(
            "Liu Liu", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData LOCOPO = new BossData(
            "Lôcôpô",
            ConstPlayer.TRAI_DAT,
...
//---------------------BOSS YARDART---------------------------------------------
    public static BossData TAP_SU_0 = new BossData(
            "Tập sự-0", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData TAP_SU_1 = new BossData(
            "Tập sự-1", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{526, 525, 524, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            10000, //dame
    ...
    public static BossData TAP_SU_2 = new BossData(
            "Tập sự-2", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{526, 525, 524, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            10000, //dame
    ...
    public static BossData TAP_SU_3 = new BossData(
            "Tập sự-3", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{526, 525, 524, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            10000, //dame
    ...
    public static BossData TAP_SU_4 = new BossData(
            "Tập sự-4", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{526, 525, 524, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            10000, //dame
    ...
    public static BossData TAN_BINH_5 = new BossData(
            "Tân binh-5", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData TAN_BINH_0 = new BossData(
            "Tân binh-0", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{527, 525, 524, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            10000, //dame
    ...
    public static BossData TAN_BINH_1 = new BossData(
            "Tân binh-1", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{527, 525, 524, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            10000, //dame
    ...
    public static BossData TAN_BINH_2 = new BossData(
            "Tân binh-2", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{527, 525, 524, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            10000, //dame
    ...
    public static BossData TAN_BINH_3 = new BossData(
            "Tân binh-3", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{527, 525, 524, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            10000, //dame
    ...
    public static BossData TAN_BINH_4 = new BossData(
            "Tân binh-4", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{527, 525, 524, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            10000, //dame
    ...
    public static BossData CHIEN_BINH_5 = new BossData(
            "Chiến binh-5", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData CHIEN_BINH_0 = new BossData(
            "Chiến binh-0", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{528, 525, 524, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            10000, //dame
    ...
    public static BossData CHIEN_BINH_1 = new BossData(
            "Chiến binh-1", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{528, 525, 524, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            10000, //dame
    ...
    public static BossData CHIEN_BINH_2 = new BossData(
            "Chiến binh-2", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{528, 525, 524, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            10000, //dame
    ...
    public static BossData CHIEN_BINH_3 = new BossData(
            "Chiến binh-3", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{528, 525, 524, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            10000, //dame
    ...
    public static BossData CHIEN_BINH_4 = new BossData(
            "Chiến binh-4", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{528, 525, 524, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            10000, //dame
    ...
    public static BossData DOI_TRUONG_5 = new BossData(
            "Đội trưởng-5", //name
            ConstPlayer.TRAI_DAT, //gender
...
//---------------------BOSS MAJINBUU 12H----------------------------------------
    public static BossData MABU_12H = new BossData(
            "Mabư",
            ConstPlayer.XAYDA,
    ...
    public static BossData GOKU = new BossData(
            "Gôku", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData CADIC = new BossData(
            "Ca Đích", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData DRABURA = new BossData(
            "Drabura",
            ConstPlayer.XAYDA,
    ...
    public static BossData DRABURA_2 = new BossData(
            "Drabura",
            ConstPlayer.XAYDA,
            new short[]{418, 419, 420, -1, -1, -1},
            100000,
    ...
    public static BossData DRABURA_3 = new BossData(
            "Drabura",
            ConstPlayer.XAYDA,
            new short[]{418, 419, 420, -1, -1, -1},
            100000,
    ...
    public static BossData BUI_BUI = new BossData(
            "Bui Bui",
            ConstPlayer.XAYDA,
    ...
    public static BossData BUI_BUI_2 = new BossData(
            "Bui Bui",
            ConstPlayer.XAYDA,
            new short[]{451, 452, 453, -1, -1, -1},
            100000,
    ...
    public static BossData YACON = new BossData(
            "Ya côn",
            ConstPlayer.XAYDA,
...
//---------------------BOSS MAJINBUU 14H----------------------------------------
    public static BossData MABU = new BossData(
            "Mabư mập",
            ConstPlayer.XAYDA,
            new short[]{297, 298, 299, -1, -1, -1},
            40000,
    ...
    public static BossData SUPER_BU = new BossData(
            "Super Bư",
            ConstPlayer.XAYDA,
    ...
    public static BossData BU_TENK = new BossData(
            "Bư Tênk",
            ConstPlayer.XAYDA,
    ...
    public static BossData BU_HAN = new BossData(
            "Bư Han",
            ConstPlayer.XAYDA,
    ...
    public static BossData KID_BU = new BossData(
            "Kid Bư",
            ConstPlayer.XAYDA,
    ...
    public static BossData SUPER_BU_BUNG = new BossData(
            "Super Bư",
            ConstPlayer.XAYDA,
            new short[]{421, 422, 423, -1, -1, -1},
            40000,
...
//---------------------BOSS TRAINNING OFFINE------------------------------------
    public static BossData WHIS = new BossData(
            "Whis", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData THAN_MEO_KARIN = new BossData(
            "Karin", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData YAJIRO = new BossData(
            "Yajirô", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData MR_POPO = new BossData(
            "Mr.PôPô", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData THUONG_DE = new BossData(
            "Thượng đế", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData KHI_BUBBLES = new BossData(
            "Khỉ Bubbles", //name
            ConstPlayer.TRAI_DAT, //gender
    ...
    public static BossData THAN_VU_TRU = new BossData(
            "Thần Vũ Trụ", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData TO_SU_KAIO = new BossData(
            "Tổ sư Kaio", //name
            ConstPlayer.XAYDA, //gender
...
//---------------------------BOSS VÕ ĐÀI SINH TỬ--------------------------------    
    public static BossData DRACULA = new BossData(
            "Đracula", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData NGUOI_VO_HINH = new BossData(
            "Người vô hình", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData BONG_BANG = new BossData(
            "Bông băng", //name
            ConstPlayer.XAYDA, //gender
    ...
    public static BossData VUA_QUY_SA_TANG = new BossData(
    ...
    public static BossData THO_DAU_BAC = new BossData(
            "Thỏ Đầu Bạc", //name
            ConstPlayer.XAYDA, //gender
