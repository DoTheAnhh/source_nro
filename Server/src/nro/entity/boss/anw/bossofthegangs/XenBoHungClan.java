 ...
 * @author DoTheAnh
 */
public class XenBoHungClan extends Boss {

    private Clan clan;
    private long lastTimeSkill = System.currentTimeMillis();

    public XenBoHungClan(Zone zone, Clan clan) throws Exception {
        super(PHOBANBBH, BossID.XEN_BO_HUNG_CLAN, new BossData(
                "Siêu bọ hung",
                ConstPlayer.TRAI_DAT,
                new short[]{234, 235, 236, -1, -1, -1},
                40_000,
                new long[]{60_000_000L},
                new int[]{165},
                ...
                if (Util.getDistance(this, pl) <= this.getRangeCanAttackWithSkillSelect()) {
                    if (System.currentTimeMillis() - lastTimeSkill >= 5000) {
                        ...
                        if (SkillUtil.isUseSkillChuong(this)) {
                            this.moveTo(
                                    pl.location.x + (Util.getOne(-1, 1) * 200),
