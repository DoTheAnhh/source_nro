...
public class Saibamen2 extends Boss {
    ...
    public Saibamen2(Zone zone, Clan clan, long dame, long hp) throws Exception {
        super(PHOBANCDRD, BossID.SAIBAMEN_2, new BossData(
                "Số 2",
                ConstPlayer.XAYDA,
    ...
    public void afk() {
        ...
        if (this.clan.ConDuongRanDoc.getNumBossAlive() < 8) {
    ...
    @Override
    public void joinMap() {
        ChangeMapService.gI().changeMap(this, this.zone, 450, 342);
