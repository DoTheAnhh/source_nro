...
public class Saibamen4 extends Boss {
    ...
    public Saibamen4(Zone zone, Clan clan, long dame, long hp) throws Exception {
        super(PHOBANCDRD, BossID.SAIBAMEN_4, new BossData(
                "Số 4",
                ConstPlayer.XAYDA,
    ...
    public void afk() {
        ...
        if (this.clan.ConDuongRanDoc.getNumBossAlive() < 6) {
    ...
    @Override
    public void joinMap() {
        ChangeMapService.gI().changeMap(this, this.zone, 480, 342);
