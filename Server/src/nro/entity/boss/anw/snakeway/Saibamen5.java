...
public class Saibamen5 extends Boss {
    ...
    public Saibamen5(Zone zone, Clan clan, long dame, long hp) throws Exception {
        super(PHOBANCDRD, BossID.SAIBAMEN_5, new BossData(
                "Số 5",
                ConstPlayer.XAYDA,
    ...
    public void afk() {
        ...
        if (this.clan.ConDuongRanDoc.getNumBossAlive() < 5) {
    ...
    @Override
    public void joinMap() {
        ChangeMapService.gI().changeMap(this, this.zone, 495, 342);
