...
public class So2Namek extends Boss {

    private long st;

    public So2Namek() throws Exception {
        super(BossID.SO_2_NAMEK, false, true, false, false, BossesData.SO_2_NAMEK);
    }
    ...
    public void doneChatE() {
        ...
        for (Boss boss : this.parentBoss.bossAppearTogether[this.parentBoss.currentLevel]) {
            if (boss.id == BossID.SO_1_NAMEK && !boss.isDie()) {
                return;
            }
        }
