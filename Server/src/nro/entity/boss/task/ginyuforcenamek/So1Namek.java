...
public class So1Namek extends Boss {

    private long st;

    public So1Namek() throws Exception {
        super(BossID.SO_1_NAMEK, false, true, false, false, BossesData.SO_1_NAMEK);
    }
    ...
    public void doneChatE() {
        ...
        for (Boss boss : this.parentBoss.bossAppearTogether[this.parentBoss.currentLevel]) {
            if (boss.id == BossID.SO_2_NAMEK && !boss.isDie()) {
                return;
            }
        }
