...
public class Cumber2 extends Boss {

    private long st;

    public Cumber2() throws Exception {
        super(BossID.DRABULA2, false, true, false, false, BossesData.Darbula2);
    }
    ...
    public void reward(Player plKill) {
        ...
        if (Util.isTrue(1, 2)) {
            ...
            ItemMap optionalItemMap = new ItemMap(this.zone, dropOptional, Util.nextInt(1, 3), x + Util.nextInt(-15, 15), y, plKill.id);
        }
