...
public class BrolyZone0 extends Boss {

    private final List<Player> playersAttack;
    private final Map angryPlayers;
    private static final int DIS_ANGRY = 100;

    public BrolyZone0() throws Exception {
        super(BROLY, BossID.BROLY_ZONE_0, new BossData(
                "Broly", // name
    ...
    @Override
    public void joinMap() {
        this.name = "Broly " + Util.nextInt(1, 130);
        this.nPoint.hpMax = Util.nextInt(500, 10000);
        this.nPoint.hp = this.nPoint.hpMax;
        this.nPoint.dame = Util.nextInt(100, 800);
        this.joinMap2();
        ...
        if (this.zone != null) {
            try {
                ...
                if (zoneid < this.zone.map.zones.size()) {
                    ...
                    if (this.id == BossID.BROLY_ZONE_0) {
            ...
            if (!charge()) {
                ...
                if (Util.getDistance(this, pl) <= this.getRangeCanAttackWithSkillSelect()) {
                    ...
                    try {
                        ...
                        Logger.logException(BrolyZone0.class, e);
                    }
