...
public class ItemTemplate {
    ...
    /**
     * Đánh dấu thủ công trong panel: vật phẩm này còn dùng được hay không.
     *
     * <p>Chỉ là một dấu tick lưu trong cột {@code item_template.dung_duoc};
     * KHÔNG gắn logic gì trong game và không gửi sang client.</p>
     */
    public boolean dungDuoc = true;
