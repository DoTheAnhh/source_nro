...
public class EpSaoTrangBi {
    ...
    /**
     * Số sao pha lê nhiều nhất một trang bị có được.
     *
     * <p>Trần <b>cứng</b> của game, đứng trên trần riêng ghi ở chỉ số 107 của
     * từng món. Chỉ số ấy do dữ liệu quyết định và có thể lên cao hơn 8
     * ({@code PhaLeHoaTrangBi} cộng dần, {@code BoMong} đặt thẳng 7), nên nếu
     * chỉ dựa vào nó thì mỗi món một trần khác nhau.</p>
     *
     * <p>Bảng hành trang cũng chặn đúng con số này khi vẽ hàng sao, nên hai bên
     * không thể lệch nhau.</p>
     */
    public static final int TOI_DA_SAO = 8;
    ...
    public static void showInfoCombine(Player player) {
        ...
        // Tran CUNG cua game la 8 sao, khong phu thuoc so lo ghi tren mon.
        //
        // Chi so 107 la tran rieng cua tung mon, va du lieu co the de cao hon 8
        // (PhaLeHoaTrangBi cong dan, BoMong dat thang 7). Chan them o day de moi
        // mon deu cung mot tran, va de bang hanh trang — cho ve hang sao — khong
        // bao gio ve dai hon thuc te.
