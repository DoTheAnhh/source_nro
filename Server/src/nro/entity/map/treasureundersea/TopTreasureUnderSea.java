...
public class TopTreasureUnderSea {

    @Getter
    private List<Clan> list = new ArrayList<>();
    
    private static final TopTreasureUnderSea INSTANCE = new TopTreasureUnderSea();
    

    public static TopTreasureUnderSea getInstance() {
        return INSTANCE;
    }
    ...
    public void load() {
        ...
        try ( Connection con = ConnectDB.getConnection();
                PreparedStatement ps = con.prepareStatement("SELECT *,CAST(SUBSTRING_INDEX(SUBSTRING_INDEX(thanhTichBDKB, ',', 1), '[', -1) AS UNSIGNED) AS part1, CAST(SUBSTRING_INDEX(SUBSTRING_INDEX(thanhTichBDKB, ',', -1), ']', 1) AS UNSIGNED) AS part2 FROM clan ORDER BY part1 DESC, part2 ASC LIMIT 100;");
            ...
            Logger.logException(TopTreasureUnderSea.class, e);
        }
    }
