...
public class MyClanTopSnakeWay {

    @Getter
    private List<Player> list = new ArrayList<>();

    private static final MyClanTopSnakeWay INSTANCE = new MyClanTopSnakeWay();

    public static MyClanTopSnakeWay getInstance() {
        return INSTANCE;
    }
    ...
    public void load2(int idLeader) {
        ...
        try (Connection con = ConnectDB.getConnection();   
            ...
            Logger.logException(MyClanTopSnakeWay.class, e);
        }
    }
