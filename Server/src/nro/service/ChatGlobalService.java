...
public class ChatGlobalService implements Runnable {
    ...
    /**
     * Lọc từ tục tĩu — <b>đang tắt</b>.
     *
     * <p>Chủ máy chủ chọn tạm bỏ chặn. Bảng {@code BAD_WORDS} giữ nguyên để
     * bật lại chỉ bằng cách bỏ dấu chú thích ở vòng lặp bên dưới.</p>
     *
     * <p>Ghi lại đây vì bảng đó chặn cả những từ rất thường: "mẹ", "bố",
     * "cha", "má", "ông", "bà", "ngu", "bug", "auto", ".com"… nên bật lên là
     * một câu chat bình thường cũng thành đầy dấu sao.</p>
     */
    private void transformText(ChatGlobal chat) {
        // for (String badWord : BAD_WORDS) {
        //     chat.text = chat.text.replaceAll(
        //             "(?i)" + Pattern.quote(badWord), "***");
        // }
    }
