...
public class TaskService {
    ...
    private static nro.service.TaskService i;

    public static nro.service.TaskService gI() {
        if (i == null) {
            i = new nro.service.TaskService();
        }
        return i;
    }
    ...
    /**
     * Nhiệm vụ KOL đã bị gỡ.
     *
     * <p>Trả chuỗi rỗng để phần mô tả nhiệm vụ chính không còn nối thêm khối
     * "[Nhiệm Vụ Kol]" nữa. Giữ lại hàm thay vì xoá hẳn để chỗ gọi không phải
     * sửa và để lịch sử thay đổi dễ đọc.</p>
     */
    private String getKolTask(Player player) {
        return "";
    }

    private String getKolTaskCu(Player player) {
