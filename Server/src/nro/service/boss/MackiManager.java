...
public class MackiManager extends Boss {

    private long lastTimeBlame;

    public MackiManager(Zone zone, int dame, int hp, int id) throws Exception {
        super(BossID.MackiManager, new BossData(
                "Phân Thân Macki",
                ConstPlayer.TRAI_DAT,
                new short[]{2012, 2013, 2014, -1, -1, -1},
