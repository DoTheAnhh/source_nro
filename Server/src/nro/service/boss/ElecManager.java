...
public class ElecManager extends Boss {

    public ElecManager(Zone zone, int dame, int hp, int id) throws Exception {
        super(BossID.ElecManager, new BossData(
                "Phân Thân Elec",
                ConstPlayer.TRAI_DAT,
                new short[]{2006, 2007, 2008, -1, -1, -1},
                Util.nextInt(80000, 150000),
                new long[]{Util.nextInt(800000000, 1500000000)},
                new int[]{199},
                new int[][]{
