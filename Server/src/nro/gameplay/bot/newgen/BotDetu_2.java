package nro.gameplay.bot.newgen;
...
public class BotDetu_2 {
    ...
    public void update(){
        ...
        if (this.bot.Detu == null && this.bot.type == 1) {
    ...
    //--------------------------------------------------------------------------
    private int[] RandomLocation_x_6 = new int[]{340 + Util.nextInt(-100, 100), 570 + Util.nextInt(-100, 100), 851, 995};
    public void MapUp_7(){
        Random random = new Random();
        int location = RandomLocation_x_6[random.nextInt(RandomLocation_x_6.length)];
        if (this.bot.zone != null && this.bot.zone.map.mapId != 31) {
            Zone zone = this.bot.getRandomZone(31);
            if (zone != null) {
    ...
    //--------------------------------------------------------------------------
    private int[] RandomLocation_x_7 = new int[]{680 + Util.nextInt(-50, 50), 480 + Util.nextInt(-50, 50), 205 + Util.nextInt(-20, -1), 395 + Util.nextInt(-20, -1), 
        565 + Util.nextInt(1, 20), 780 + Util.nextInt(1, 20)};
    public void MapUp_8(){
        Random random = new Random();
        int location = RandomLocation_x_7[random.nextInt(RandomLocation_x_7.length)];
        if (this.bot.zone != null && this.bot.zone.map.mapId != 32) {
            Zone zone = this.bot.getRandomZone(32);
            if (zone != null) {
                ChangeMapService.gI().goToMap(this.bot, zone);
                this.bot.zone.load_Me_To_Another(this.bot);
    ...
    //--------------------------------------------------------------------------
    private int[] RandomLocation_x_8 = new int[]{600 + Util.nextInt(-100, 100), 1300 + Util.nextInt(-100, 100)};
    public void MapUp_9(){
        Random random = new Random();
        int location = RandomLocation_x_8[random.nextInt(RandomLocation_x_8.length)];
        if (this.bot.zone != null && this.bot.zone.map.mapId != 33) {
            Zone zone = this.bot.getRandomZone(33);
            if (zone != null) {
                ChangeMapService.gI().goToMap(this.bot, zone);
                this.bot.zone.load_Me_To_Another(this.bot);
                PlayerService.gI().playerMove(this.bot, location, 360);
    ...
    //--------------------------------------------------------------------------
    private int[] RandomLocation_x_9 = new int[]{350 + Util.nextInt(-100, 100), 900 + Util.nextInt(-100, 100)};
    public void MapUp_10(){
        Random random = new Random();
        int location = RandomLocation_x_9[random.nextInt(RandomLocation_x_9.length)];
        if (this.bot.zone != null && this.bot.zone.map.mapId != 34) {
            Zone zone = this.bot.getRandomZone(34);
            if (zone != null) {
                ChangeMapService.gI().goToMap(this.bot, zone);
                this.bot.zone.load_Me_To_Another(this.bot);
    ...
    //--------------------------------------------------------------------------
    private int[] RandomLocation_x_10 = new int[]{1100 + Util.nextInt(-100, 100)};
    public void MapUp_11(){
        Random random = new Random();
        int location = RandomLocation_x_10[random.nextInt(RandomLocation_x_10.length)];
        if (this.bot.zone != null && this.bot.zone.map.mapId != 13) {
            Zone zone = this.bot.getRandomZone(13);
            if (zone != null) {
                ChangeMapService.gI().goToMap(this.bot, zone);
                this.bot.zone.load_Me_To_Another(this.bot);
    ...
    //--------------------------------------------------------------------------
    private int[] RandomLocation_x_11 = new int[]{420 + Util.nextInt(-100, 200), 750 + Util.nextInt(-200, 100)};
    public void MapUp_12(){
        Random random = new Random();
        int location = RandomLocation_x_11[random.nextInt(RandomLocation_x_11.length)];
        if (this.bot.zone != null && this.bot.zone.map.mapId != 10) {
            Zone zone = this.bot.getRandomZone(10);
            if (zone != null) {
                ChangeMapService.gI().goToMap(this.bot, zone);
                this.bot.zone.load_Me_To_Another(this.bot);
                PlayerService.gI().playerMove(this.bot, location, 288);
