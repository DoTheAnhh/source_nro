...
public class BotDetu_8 {
    ...
    public void update(){
        ...
        if (this.bot.Detu == null && this.bot.type == 7) {
    ...
    //--------------------------------------------------------------------------
    private int[] RandomLocation_x_12 = new int[]{295 + Util.nextInt(-10, 10), 500 + Util.nextInt(-10, 10), 695 + Util.nextInt(-10, 10), 895 + Util.nextInt(-10, 10), 1085 + Util.nextInt(-10, 10)};
    public void MapUp_28(){
        Random random = new Random();
        int location = RandomLocation_x_12[random.nextInt(RandomLocation_x_12.length)];
        if (this.bot.zone != null && this.bot.zone.map.mapId != 92) {
            Zone zone = this.bot.getRandomZone(92);
            if (zone != null) {
    ...
    //--------------------------------------------------------------------------
    private int[] RandomLocation_x_13 = new int[]{563 + Util.nextInt(0, 20), 997 + Util.nextInt(-20, 0), 1501 + Util.nextInt(-20, 0)};
    public void MapUp_29(){
        Random random = new Random();
        int location = RandomLocation_x_13[random.nextInt(RandomLocation_x_13.length)];
        if (this.bot.zone != null && this.bot.zone.map.mapId != 93) {
            Zone zone = this.bot.getRandomZone(93);
            if (zone != null) {
                ChangeMapService.gI().goToMap(this.bot, zone);
                this.bot.zone.load_Me_To_Another(this.bot);
                PlayerService.gI().playerMove(this.bot, location, 360);
    ...
    //--------------------------------------------------------------------------
    private int[] RandomLocation_x_14 = new int[]{700 + Util.nextInt(-20, 20), 940 + Util.nextInt(-20, 20)};
    public void MapUp_30(){
        Random random = new Random();
        int location = RandomLocation_x_14[random.nextInt(RandomLocation_x_14.length)];
        if (this.bot.zone != null && this.bot.zone.map.mapId != 94) {
            Zone zone = this.bot.getRandomZone(94);
            if (zone != null) {
                ChangeMapService.gI().goToMap(this.bot, zone);
                this.bot.zone.load_Me_To_Another(this.bot);
    ...
    //--------------------------------------------------------------------------
    private int[] RandomLocation_x_15 = new int[]{333 + Util.nextInt(-20, 20),555 + Util.nextInt(-20, 20),770 + Util.nextInt(-20, 20),1000 + Util.nextInt(-20, 20),1260 + Util.nextInt(-20, 20)};
    public void MapUp_31(){
        Random random = new Random();
        int location = RandomLocation_x_15[random.nextInt(RandomLocation_x_15.length)];
        if (this.bot.zone != null && this.bot.zone.map.mapId != 97) {
            Zone zone = this.bot.getRandomZone(97);
            if (zone != null) {
                ChangeMapService.gI().goToMap(this.bot, zone);
                this.bot.zone.load_Me_To_Another(this.bot);
                PlayerService.gI().playerMove(this.bot, location, 384);
    ...
    private int[] RandomLocation_x_16 = new int[]{515 + Util.nextInt(0, 20), 709 + Util.nextInt(-20, 0)};
    public void MapUp_32(){
        Random random = new Random();
        int location = RandomLocation_x_16[random.nextInt(RandomLocation_x_16.length)];
        if (this.bot.zone != null && this.bot.zone.map.mapId != 98) {
            Zone zone = this.bot.getRandomZone(98);
            if (zone != null) {
                ChangeMapService.gI().goToMap(this.bot, zone);
                this.bot.zone.load_Me_To_Another(this.bot);
                PlayerService.gI().playerMove(this.bot, location, 384);
    ...
    //--------------------------------------------------------------------------
    private int[] RandomLocation_x_17 = new int[]{589 + Util.nextInt(-15, 0), 1165 + Util.nextInt(-20, 0)};
    public void MapUp_33(){
        Random random = new Random();
        int location = RandomLocation_x_17[random.nextInt(RandomLocation_x_17.length)];
        if (this.bot.zone != null && this.bot.zone.map.mapId != 100) {
            Zone zone = this.bot.getRandomZone(100);
            if (zone != null) {
                ChangeMapService.gI().goToMap(this.bot, zone);
                this.bot.zone.load_Me_To_Another(this.bot);
                PlayerService.gI().playerMove(this.bot, location, 384);
