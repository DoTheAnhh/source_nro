...
public class BotAttackPlayer_1 {
    ...
    public BotAttackPlayer_1(boolean Start){
        this.StartGame = Start;
    }
   
    public BotAttackPlayer_1(BotAttackPlayer_1 dt){
    ...
    public void FixmoveTo(int y) {
        ...
        } else if (this.bot.zone.map.mapId == 0 ? this.bot.location.x > 1200 : this.bot.location.x > 1400) {
            PlayerService.gI().playerMove(this.bot, this.bot.zone.map.mapId == 0 ? Util.nextInt(1150, 1190) : Util.nextInt(1350, 1390), y);
        }
    }    
    ...
    private void MapUp_1(){
        ...
        if (this.bot.zone != null && this.bot.zone.map.mapId != 0) {
            Zone zone = this.bot.getRandomZone(0);
            if (zone != null) {
