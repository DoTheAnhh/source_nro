...
public class BotDetu_4 {
    ...
    public void update(){
        ...
        if (this.bot.Detu == null && this.bot.type == 3) {
    ...
    public void CheckPower() {
        ...
        if (power >= 5_000_000_000L && power < 10_000_000_000L) {
            this.MapUp_19();
        } else if (power >= 10_000_000_000L && power < 15_000_000_000L) {
            this.MapUp_20();
        } else if (power >= 15_000_000_000L && power < 20_000_000_000L) {
            this.MapUp_21();
        }
    }
    
    //--------------------------------------------------------------------------
    private int[] RandomLocation_x_12 = new int[]{460 + Util.nextInt(-100, 100), 1070 + Util.nextInt(-100, 100)};
    public void MapUp_19(){
        Random random = new Random();
        int location = RandomLocation_x_12[random.nextInt(RandomLocation_x_12.length)];
        if (this.bot.zone != null && this.bot.zone.map.mapId != 68) {
            Zone zone = this.bot.getRandomZone(68);
            if (zone != null) {
    ...
    //--------------------------------------------------------------------------
    private int[] RandomLocation_x_13 = new int[]{720 + Util.nextInt(-300, 300)};
    public void MapUp_20(){
        Random random = new Random();
        int location = RandomLocation_x_13[random.nextInt(RandomLocation_x_13.length)];
        if (this.bot.zone != null && this.bot.zone.map.mapId != 69) {
            Zone zone = this.bot.getRandomZone(69);
            if (zone != null) {
                ChangeMapService.gI().goToMap(this.bot, zone);
                this.bot.zone.load_Me_To_Another(this.bot);
    ...
    //--------------------------------------------------------------------------
    private int[] RandomLocation_x_14 = new int[]{500 + Util.nextInt(-400, 400)};
    public void MapUp_21(){
        Random random = new Random();
        ...
        if (this.bot.zone != null && this.bot.zone.map.mapId != 70) {
            ...
            if (zone != null) {
                ChangeMapService.gI().goToMap(this.bot, zone);
                this.bot.zone.load_Me_To_Another(this.bot);
                PlayerService.gI().playerMove(this.bot, location, 528);
            }
        }
    }
}
