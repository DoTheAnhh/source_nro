...
public class BotAttackPlayer_3 {
    ...
    public BotAttackPlayer_3(boolean Start){
        this.StartGame = Start;
    }
   
    public BotAttackPlayer_3(BotAttackPlayer_3 dt){
    ...
    public void FixmoveTo(int y) {
        ...
        } else if (this.bot.zone.map.mapId == 14 ? this.bot.location.x > 1200 : this.bot.location.x > 1400) {
            PlayerService.gI().playerMove(this.bot, this.bot.zone.map.mapId == 14 ? Util.nextInt(1150, 1190) : Util.nextInt(1350, 1390), y);
        }
    }    
    ...
    private void MapUp_1(){
        ...
        if (this.bot.zone != null && this.bot.zone.map.mapId != 14) {
            Zone zone = this.bot.getRandomZone(14);
            if (zone != null) {
    ...
    //--------------------------------------------------------------------------
    private int[] RandomLocation_x_2 = new int[]{1050 + Util.nextInt(-150, 150)};
