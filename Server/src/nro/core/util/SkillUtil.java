...
public class SkillUtil {
    ...
    public static int getPercentDameMonkey(int level) { // tỉ lệ dame khỉ cộng thêm
        return (level + 3);
    }
    ...
    public static int getTimeTranformation() { // thời gian tồn tại
        return 300000;
    }
    ...
    public static int getPercentDameSucManhBocPha(int level) {
        return (level + 1) * 5;
    }

    public static int getTimeSucManhBocPha(int level) {
        return (level + 5) * 5000;
    }
    ...
    // item vòng kim cô
    public static int getTempVongKimCo(int level) { // template vòng kim cô
        int[] temp = {69, 75, 79, 87, 92};
        return temp[level - 1];
    }

    public static int getTimeSurviveVongKimCo(int level) { // thời gian mob tồn tại
        return 180000;
    }

    public static int getHPVongKimCo(int hpMaxPlayer, int level) { // lấy hp max của mob theo hp max player
        int[] perHPs = {100, 110, 120, 130, 140};
        return hpMaxPlayer * perHPs[level - 1] / 100;
    }

    public static int getDAMEVongKimCo(int DAMEPlayer, int level) { // lấy dame max của mob theo hp max player
        int[] perDAMEs = {100, 110, 120, 130, 140};
        return DAMEPlayer * perDAMEs[level - 1] / 100;
    }
