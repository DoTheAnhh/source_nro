...
public class ConstTaskBadges {
    ...
    public static final byte GO_DAU_TRE_1 = 13;
    public static final byte GO_DAU_TRE_2 = 14;
    public static final byte GO_DAU_TRE_3 = 15;
    public static final byte XMASS = 16;
    public static final byte EM_XINH_EM_DEP = 17;
    public static final byte TAY_NHANH_HON_NAO = 18;
    public static final byte KOL = 19;
    public static final byte MUA_DONG_KHONG_LANH = 20;
    public static final byte ME_RONG = 21;
}
