...
public class ConstMap {
    ...
    public static final byte MAP_MA_BU_12H = 5;
    public static final byte MAP_KHI_GAS_HUY_DIET = 6;
    public static final byte MAP_DAO_KHO_BAU = 7;
    public static final byte MAP_CON_DUONG_RAN_DOC = 8;
    public static final byte MAP_GIAI_CUU_MI_NUONG = 9;
    public static final byte MAP_HIRUDEGARN = 10;
    public static final byte MAP_MABU_14H = 11;
    public static final byte MAP_TAY_KARIN = 12;
    public static final byte MAP_BANG_HOI = 13;
    public static final byte MAP_BOSS_BANG_HOI = 14;
