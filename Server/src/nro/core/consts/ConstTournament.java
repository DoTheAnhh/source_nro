...
public class ConstTournament {
    ...
    public static final String TEXT_TRUAT_QUYEN = "Những cái loại ngủ quá giờ trưa ý, tao đố thằng nào giàu được.";
    ...
    public static final String TEXT_CHIA_BUON = "Xin lỗi vì quá đẹp trai";
    ...
    public static final String TEXT_NPC_CHAT_HET_GIO = "Hết giờ thi đấu %1 đã chiến thắng vì quá đẹp trai";
    ...
    public static final String TEXT_VO_DICH = "Bạn đã vô địch giải đấu, xin chúc mừng bạn, bạn được thưởng 5 viên đá nâng cấp và 30 thỏi vàng";
