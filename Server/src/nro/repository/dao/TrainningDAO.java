 ...
 */
/**
 * Đọc/ghi dữ liệu phòng tập luyện.
 *
 * <p><b>Tên lớp sai chính tả</b>: {@code Trainning} -> {@code Training}. Lỗi này
 * lặp lại ở nhiều nơi khác trong project (ví dụ {@code nro.boss.map.TrainingBoss}
 * lại viết đúng), nên phải tra cả hai cách khi tìm kiếm.
 */
