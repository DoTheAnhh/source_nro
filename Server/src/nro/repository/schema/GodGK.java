...
//}
    ...
    private static Player loadPlayer(CrisResultSet rs, boolean isOffline) throws Exception {
        ...
        try {
            ...
            // NRO Pass cao cap mua nay: bang nro_pass_nguoi la nguon su that, du
            // lieu nhan vat chi luu theo nhip nen co the cu hon sau mot lan sap may.
            nro.service.NroPassService.gI().dongBoKhiNap(player);
