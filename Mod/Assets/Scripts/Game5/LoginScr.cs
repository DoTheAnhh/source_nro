...
namespace Game5
{
    ...
    public class LoginScr : mScreen, IActionListener
    {
    	...
    	public LoginScr()
    	{
    		...
    		tfUser.setText(Rms.loadRMSString("acc5"));
    		tfPass.setText(Rms.loadRMSString("pass5"));
    	...
    	{
    		string text = Rms.loadRMSString("acc5");
    		if (text != null && !text.Equals(string.Empty))
    		{
    			tfUser.setText(text);
    		}
    		string text2 = Rms.loadRMSString("pass5");
    	...
    	protected void doRegister(string user)
    	{
    		...
    		Service.gI().requestRegister(user, tfPass.getText(), Rms.loadRMSString("userAo5" + ServerListScreen.ipSelect), Rms.loadRMSString("passAo" + ServerListScreen.ipSelect), GameMidlet.VERSION);
    		Rms.saveRMSString("acc5", user);
    		Rms.saveRMSString("pass5", tfPass.getText());
    	...
    	public void doLogin()
    	{
    		...
    		else if (Rms.loadRMSString("userAo5" + ServerListScreen.ipSelect) != null && !Rms.loadRMSString("userAo5" + ServerListScreen.ipSelect).Equals(string.Empty))
    		{
    			isLogin2 = true;
    		}
    		else
    		...
    		{
    			text = Rms.loadRMSString("userAo5" + ServerListScreen.ipSelect);
    			text2 = "a";
    		}
    	...
    	public void savePass()
    	{
    		if (isCheck)
    		{
    			...
    			Rms.saveRMSString("acc5", tfUser.getText().ToLower().Trim());
    			Rms.saveRMSString("pass5", tfPass.getText().ToLower().Trim());
    		}
    		else
    		{
    	...
    	public void perform(int idAction, object p)
    	{
    		...
    		{
    			GameCanvas.startWaitDlg();
    			string text = Rms.loadRMSString("userAo5" + ServerListScreen.ipSelect);
    			if (text == null || text.Equals(string.Empty))
    			{
    		...
    		case 2004:
    			...
    			break;
    		case 2008:
    			Rms.saveRMSString("acc5", tfUser.getText().Trim());
    			Rms.saveRMSString("pass5", tfPass.getText().Trim());
