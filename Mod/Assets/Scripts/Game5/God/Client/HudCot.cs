namespace Game5.God
{
    ...
    public static class HudCot
    {
        ...
        {
            if (Game5.Char.isLoadingMap
                    || Game5.LoginScr.isContinueToLogin
                    || Game5.ServerListScreen.waitToLogin
                    || Game5.ServerListScreen.isWait)
            {
                return false;
            }
            return Game5.GameCanvas.currentScreen is Game5.GameScr;
        }
