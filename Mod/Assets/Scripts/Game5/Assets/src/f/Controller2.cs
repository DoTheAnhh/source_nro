			...
			try
			{
				...
				case 93:
				{
					...
					if (str != null && str.Contains(" vừa xuất hiện tại "))
					{
						try
						{
							Game5.God.BossData.getInstance().getBOSSInfo(str);
						}
						catch (Exception)
						{
						}
				...
				case -102:
				{
					...
					if (b11 != 0 && b11 == 1)
					{
						...
						Service.gI().login(Rms.loadRMSString("acc5"), Rms.loadRMSString("pass5"), GameMidlet.VERSION, 0);
				...
				case -101:
				{
					...
					Rms.saveRMSString("userAo5" + ServerListScreen.ipSelect, text2);
