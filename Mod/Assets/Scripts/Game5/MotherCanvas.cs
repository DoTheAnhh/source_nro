...
namespace Game5
{
    public class MotherCanvas
    {
    	...
    	public void checkZoomLevel(int w, int h)
    	{
    		...
    		{
    			// Ban may tinh chan muc phong o 2.
    			//
    			// Da thu cho ban PC dung chung thang do voi dien thoai (them muc 3
    			// va 4): cua so binh thuong roi vao muc 3, khung ao tut xuong con
    			// hon ba tram diem, va ca HUD phong to den muc de len nhau. Muc 2 la
    			// muc bo cuc HUD nay duoc can theo.
    			mGraphics.zoomLevel = 2;
    			if (w * h < 480000)
    			{
