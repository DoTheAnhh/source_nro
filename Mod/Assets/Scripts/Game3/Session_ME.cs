    	...
    	private class MessageCollector
    	{
    		...
    		private Message readMessage()
    		{
    			try
    			{
    				...
    				// Tam lenh may chu gui kem do dai 3 BYTE. Phai khop tung so voi
    				// MessageSendCollect.doSendMessage ben may chu. Thieu -28 la goi bang
    				// vat pham (vuot 64 KiB) bi doc sai do dai, va tu do MOI goi sau deu
    				// lech khung — client dung im o man tai, khong bao loi gi.
    				if (b == -32 || b == -66 || b == -74 || b == 11 || b == -67 || b == -87 || b == 66 || b == -28)
    				{
