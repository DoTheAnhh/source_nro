                    ...
                    case -74:
                        {
                            ...
                            if (!GameCanvas.isGetResourceFromServer())
                            {
                                ...
                                if (Rms.loadRMSString("acc3") != null || Rms.loadRMSString("userAo3" + ServerListScreen.ipSelect) != null)
                                {
                    ...
                    case 1:
                        {
                            ...
                            Rms.saveRMSString("userAo3" + ServerListScreen.ipSelect, string.Empty);
                            GameCanvas.endDlg();
                            GameCanvas.loginScr.doLogin();
                            break;
                        }
                    ...
                    case -72:
                        {
                            ...
                            Game3.God.ClientManager.ketThucDemNguocMayDam =
                                    (giayDam <= 0) ? 0L
                    ...
                    case 4:
                        {
                            ...
                            {
                                Rms.saveRMSString("acc3", string.Empty);
                                Rms.saveRMSString("pass3", string.Empty);
                            }
                            else
                            {
                                Rms.saveRMSString("userAo3" + ServerListScreen.ipSelect, string.Empty);
