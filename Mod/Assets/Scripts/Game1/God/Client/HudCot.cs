namespace Game1.God
{
    ...
    public static class HudCot
    {
        ...
        {
            if (Game1.Char.isLoadingMap
                    || Game1.LoginScr.isContinueToLogin
                    || Game1.ServerListScreen.waitToLogin
                    || Game1.ServerListScreen.isWait)
            {
                return false;
            }
            return Game1.GameCanvas.currentScreen is Game1.GameScr;
        }
