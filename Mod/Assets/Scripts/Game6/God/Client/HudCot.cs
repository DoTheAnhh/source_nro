namespace Game6.God
{
    ...
    public static class HudCot
    {
        ...
        {
            if (Game6.Char.isLoadingMap
                    || Game6.LoginScr.isContinueToLogin
                    || Game6.ServerListScreen.waitToLogin
                    || Game6.ServerListScreen.isWait)
            {
                return false;
            }
            return Game6.GameCanvas.currentScreen is Game6.GameScr;
        }
