                    ...
                    case -74:
                        {
                            ...
                            if (!GameCanvas.isGetResourceFromServer())
                            {
                                ...
                                if (Rms.loadRMSString("acc6") != null || Rms.loadRMSString("userAo6" + ServerListScreen.ipSelect) != null)
                                {
                    ...
                    case 1:
                        {
                            ...
                            Rms.saveRMSString("userAo6" + ServerListScreen.ipSelect, string.Empty);
                            GameCanvas.endDlg();
                            GameCanvas.loginScr.doLogin();
                            break;
                        }
                    ...
                    case -72:
                        {
                            ...
                            Game6.God.ClientManager.ketThucDemNguocMayDam =
                                    (giayDam <= 0) ? 0L
