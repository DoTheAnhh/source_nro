...
namespace Game6
{
    ...
    public class MyKeyMap
    {
    	...
    	/// <summary>W A S D doi thanh ma phim mui ten, 0 neu khong phai.</summary>
    	/// <remarks>
    	/// Tra ve dung nhung ma mui ten co san (-1 len, -2 xuong, -3 trai,
    	/// -4 phai) nen phan dieu khien ben duoi khong phai biet gi ve WASD.
    	/// </remarks>
    	public static int wasd(KeyCode k)
    	{
    		switch (k)
    		{
    		case KeyCode.W:
