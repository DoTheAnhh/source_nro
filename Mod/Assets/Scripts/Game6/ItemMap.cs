...
namespace Game6
{
    public class ItemMap : IMapObject
    {
    	...
    	{
    		// template null khi client chua biet vat pham nay — vi du may
    		// chu vua them mon moi ma client con dung bang vat pham cu
    		// trong bo nho dem. Truoc day cham thang template.type nen
    		// mon la roi xuong dat la nem NullReferenceException MOI
    		// KHUNG HINH, log tran ngay lap tuc.
    		if (template == null)
    		{
    			return false;
    		}
