...
namespace Game4
{
    ...
    public class ChatPopup : Effect2, IActionListener
    {
    	...
    	/// <summary>
    	/// Tin nhan lon cua may chu. Ngoai viec bat hop noi nhu cu, con ghi
    	/// vao nhat ky cua khung chat de doc lai duoc.
    	/// </summary>
    	/// <remarks>
    	/// Hop noi tu tat sau vai giay va khong luu gi; bo lo mot dong la mat
    	/// han. Ghi them vao nhat ky chu KHONG thay the hop noi — tat khung
    	/// chat di thi van khong mat tin nao.
    	/// </remarks>
    	public static void addBigMessage(string chat, int howLong, Npc c)
    	{
    		God.ChatUI.getInstance().nhanTinMayChu(chat);
