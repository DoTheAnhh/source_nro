			...
			try
			{
				...
				case 93:
				{
					...
					if (str != null && str.Contains(" vừa xuất hiện tại "))
					{
						try
						{
							Game4.God.BossData.getInstance().getBOSSInfo(str);
						}
						catch (Exception)
						{
						}
				...
				case -102:
				{
					...
					if (b11 != 0 && b11 == 1)
					{
						...
						Service.gI().login(Rms.loadRMSString("acc4"), Rms.loadRMSString("pass4"), GameMidlet.VERSION, 0);
				...
				case -101:
				{
					...
					Rms.saveRMSString("userAo4" + ServerListScreen.ipSelect, text2);
