namespace Game4.God
{
    ...
    public static class HudCot
    {
        ...
        {
            if (Game4.Char.isLoadingMap
                    || Game4.LoginScr.isContinueToLogin
                    || Game4.ServerListScreen.waitToLogin
                    || Game4.ServerListScreen.isWait)
            {
                return false;
            }
            return Game4.GameCanvas.currentScreen is Game4.GameScr;
        }
