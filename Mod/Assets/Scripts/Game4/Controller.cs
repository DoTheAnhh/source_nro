                    ...
                    case -74:
                        {
                            ...
                            if (!GameCanvas.isGetResourceFromServer())
                            {
                                ...
                                if (Rms.loadRMSString("acc4") != null || Rms.loadRMSString("userAo4" + ServerListScreen.ipSelect) != null)
                                {
                    ...
                    case 1:
                        {
                            ...
                            Rms.saveRMSString("userAo4" + ServerListScreen.ipSelect, string.Empty);
                            GameCanvas.endDlg();
                            GameCanvas.loginScr.doLogin();
                            break;
                        }
                    ...
                    case -72:
                        {
                            ...
                            Game4.God.ClientManager.ketThucDemNguocMayDam =
                                    (giayDam <= 0) ? 0L
                    ...
                    case 4:
                        {
                            ...
                            {
                                Rms.saveRMSString("acc4", string.Empty);
                                Rms.saveRMSString("pass4", string.Empty);
                            }
                            else
                            {
                                Rms.saveRMSString("userAo4" + ServerListScreen.ipSelect, string.Empty);
