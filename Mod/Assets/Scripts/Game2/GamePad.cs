...
namespace Game2
{
    ...
    public class GamePad
    {
    	...
    	public void paint(mGraphics g)
    	{
    		if (GameScr.isAnalog != 0)
    		{
    			// KHONG dat lai vung cham o day nua.
    			//
    			// Day la ham VE, ma no lai gan de bon truong xZone/yZone/wZone/hZone
    			// moi khung hinh — de dung con so 3/4 be ngang cua ban cu. Nghia la
    			// bat cu thay doi nao o ham dung cung bi xoa ngay khung dau tien:
    			// hang o ky nang tinh cho dat theo wZone luc khoi tao, roi wZone lai
    			// nhay ve so cu, va hang o dung o cho khong con lien quan gi toi
    			// vung cham nua.
    			//
    			// Day dung la ly do may lan keo hang o ky nang sang trai deu khong
    			// an gi tren ban dien thoai.
    			//
    			// Van phai tinh lai moi khung: cua so doi kich co thi vung phai
    			// doi theo, va do chinh la viec duy nhat doan ma cu lam dung.
    			datVungCham();
