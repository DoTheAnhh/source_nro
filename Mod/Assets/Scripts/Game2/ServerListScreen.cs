...
namespace Game2
{
    ...
    public class ServerListScreen : mScreen, IActionListener
    {
    	...
    	private void initCommand()
    	{
    		...
    		if (text == null)
    		{
    			if (Rms.loadRMS("userAo2" + ipSelect) != null)
    			{
    				nCmdPlay = 1;
    			}
    		}
    	...
    	public void perform(int idAction, object p)
    	{
    		...
    		if (idAction == 3)
    		{
    			...
    			bool flag = Rms.loadRMSString("acc2") != null && !Rms.loadRMSString("acc2").Equals(string.Empty);
    			bool flag2 = Rms.loadRMSString("userAo2" + ipSelect) != null && !Rms.loadRMSString("userAo2" + ipSelect).Equals(string.Empty);
    			if (!flag && !flag2)
    			{
    				// May chua co tai khoan nao: day cung la nut "Choi moi", nen di
    				// dung duong dang ky nhu nhanh 10100 thay vi tao tai khoan ao.
    				string text = Rms.loadRMSString("userAo2" + ipSelect);
    		...
    		if (idAction == 11)
    		{
    			...
    			GameCanvas.loginScr.switchToMe();
    			string text2 = Rms.loadRMSString("userAo2" + ipSelect);
