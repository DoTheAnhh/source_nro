...
namespace Game2
{
    ...
    public class LoginScr : mScreen, IActionListener
    {
    	...
    	public void doLogin()
    	{
    		...
    		else if (Rms.loadRMSString("userAo2" + ServerListScreen.ipSelect) != null && !Rms.loadRMSString("userAo2" + ServerListScreen.ipSelect).Equals(string.Empty))
    		{
    			isLogin2 = true;
    		}
    		else
    	...
    	public void perform(int idAction, object p)
    	{
    		...
    		{
    			GameCanvas.startWaitDlg();
    			string text = Rms.loadRMSString("userAo2" + ServerListScreen.ipSelect);
    			if (text == null || text.Equals(string.Empty))
    			{
