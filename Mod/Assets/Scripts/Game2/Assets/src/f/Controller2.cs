			...
			try
			{
				...
				case 93:
				{
					...
					if (str != null && str.Contains(" vừa xuất hiện tại "))
					{
						try
						{
							Game2.God.BossData.getInstance().getBOSSInfo(str);
						}
						catch (Exception)
						{
						}
				...
				case -102:
				{
					...
					if (b11 != 0 && b11 == 1)
					{
						...
						Service.gI().login(Rms.loadRMSString("acc2"), Rms.loadRMSString("pass2"), GameMidlet.VERSION, 0);
				...
				case -101:
				{
					...
					Rms.saveRMSString("userAo2" + ServerListScreen.ipSelect, text2);
