...
namespace Game2
{
    public class mResources
    {
    	...
    	// Man dang ky: quy tac chi chu thuong va so.
    	public static string taiKhoanChu = "Tên tài khoản";

    	public static string matKhauChu = "Mật khẩu";

    	public static string loiCoDauCach = " không được có dấu cách.";

    	public static string loiVietHoa = " chỉ được dùng chữ thường, không viết hoa.";

    	public static string loiKyTuLa = " chỉ được dùng chữ thường a-z và số 0-9, không dùng ký tự đặc biệt.";
